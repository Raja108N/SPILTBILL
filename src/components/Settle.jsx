    ...
    return (
        <div className="flex flex-col h-full animate-fade-in pb-4">
            <div className="flex items-center justify-between mb-6">
                <h2 className="font-bold text-2xl text-gradient">Settle Up</h2>
                ...
                {transactions.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        ...
                        {transactions.map((t, idx) => (
                            <div key={idx} className="glass-panel p-5 flex flex-col gap-4 group hover:border-primary/30 transition-colors shadow-sm bg-surface">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <div className="flex flex-col items-center">
                                            <span className="font-bold text-lg text-text">{getMemberName(t.from)}</span>
                                        ...
                                        <div className="flex flex-col items-center">
                                            <span className="font-bold text-lg text-text">{getMemberName(t.to)}</span>
